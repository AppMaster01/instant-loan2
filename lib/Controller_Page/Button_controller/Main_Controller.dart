...
import 'package:loan_instant_2/main.dart';
...
class ButtonController extends GetxController {
  ...
  showbuttonad(BuildContext context, String page, String name, var arg) async {
    if (LoanData.value["COUNTER"] == buttoncounter.value) {
      ...
      if (LoanData.value[name]["INTER_AD_TYPE"] == 'ADMOB') {
        InterstitialAd.load(
          adUnitId: LoanData.value[name]["INTER_ADMOB"],
      ...
      if (LoanData.value[name]["INTER_AD_TYPE"] == 'FB') {
        FacebookInterstitialAd.loadInterstitialAd(
          placementId: LoanData.value["INTER_FB"],
      ...
      if (LoanData.value[name]["INTER_AD_TYPE"] == "URL") {
        // log("Loading");
