...
class insurance_3 extends StatefulWidget {


  const insurance_3({Key? key}) : super(key: key);

  @override
  State<insurance_3> createState() => _insurance_3State();
}

class _insurance_3State extends State<insurance_3> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () =>
          backbuttoncontroller.showBackbuttonad(context, '/insurance_3', abc),
      child: Scaffold(
                      ...
                      controllerContainer.getcontainer(() {
                        if (BDATE.value.text.isEmpty ||
                          ...
                          controller.showbuttonad(
                              context, '/insurance_4', '/insurance_3', '');
                        }
                      },
                          const Color(0xff009A73),
                          Center(
