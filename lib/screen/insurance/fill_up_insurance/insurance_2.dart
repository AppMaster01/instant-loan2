...
class insurance_2 extends StatefulWidget {


  const insurance_2({Key? key}) : super(key: key);

  @override
  State<insurance_2> createState() => _insurance_2State();
}

class _insurance_2State extends State<insurance_2> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () =>
          backbuttoncontroller.showBackbuttonad(context, '/insurance_2', abc),
      child: Scaffold(
                      ...
                      controllerContainer.getcontainer(() {
                        if (ADDS.value.text.isEmpty ||
                          ...
                          controller.showbuttonad(
                              context, '/insurance_3', '/insurance_2', abc);
                        }
                      },
